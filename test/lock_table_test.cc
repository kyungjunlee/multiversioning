...
// NOTE:
//    The test below has been commented out since we are no longer ensuring on
//    this level that only one thread may do the merging. More may be allowed
//    and consistency must be ensured on higher levels.
//

#ifndef BATCHED_SPSC_MR_QUEUE_H_
#define BATCHED_SPSC_MR_QUEUE_H_

#include <memory>
#include <pthread.h>
// TODO:
//    There really should be an interface defining these queues 
//    because right now we have too much repetition without
//    clear reasoning. An interface will at least clear that
//    up.
//
